...
import { collection, query, where, getDocs,documentId, updateDoc,doc } from "firebase/firestore";
...
const ProfileScreen = () => {
  ...
  useEffect(() => {
    const fetchImageUrl = async () => {
      try {
        ...
        const userQuery = query(usersCollectionRef,where(documentId(), "==", sessionId));
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", margin: "70px auto", minHeight: "80vh", width: "50vw", padding: "10px", border: "3px solid", color: "#AF68EF", borderRadius: "" }}>

        <div className='profile' style={{ display: "flex", alignItems: "center", flexDirection: "column", marginBottom: "30px", margin: "10px", color: "#F00000", marginTop: "10px" }}>
