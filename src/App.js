...
import Calendaratnd from "./components/Calendar-atnd/Calendaratnd";
...
import VerticalTabs from "./components/test/test";
      ...
      <div className="Authorization">
        <Router>
          <Routes>
            ...
            <Route path="/share" element={<ShareBtn />} />
          <Route path = "/test" element = {<VerticalTabs/>}/>
          </Routes>
        </Router>
      </div>
